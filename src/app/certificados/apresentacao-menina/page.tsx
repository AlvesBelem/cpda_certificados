  ...
  return (
    <main className="mx-auto w-full max-w-6xl space-y-6 px-6 py-12 md:px-10 lg:px-16">
      <header className="space-y-4">
        ...
        <h1 className="text-2xl font-semibold text-foreground">Apresentacao de Criancas (Menina)</h1>
        <p className="text-sm text-muted-foreground">
          Preencha os campos da familia e gere o certificado de apresentacao infantil. O layout permanece intacto.
        </p>
      ...
      <Card className="border-border/60 bg-card/80">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">Informe ou envie a logo que deve aparecer no cabecalho.</p>
          </div>
      ...
      <Card className="border-border/60 bg-card/80">
        <CardHeader>
          ...
          <CardDescription>Preencha os dados da crianca para gerar o certificado.</CardDescription>
        </CardHeader>
        <CardContent>
