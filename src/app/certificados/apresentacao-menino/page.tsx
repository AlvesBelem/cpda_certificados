...
import { ApresentacaoMeninoCertificateBuilder } from "../_components/apresentacao-menino-certificate-builder";

export default function CertificadoApresentacaoMeninoPage() {
    ...
    <main className="mx-auto w-full max-w-6xl space-y-6 px-6 py-12 md:px-10 lg:px-16">
      ...
      <Card className="border-border/60 bg-card/80">
        <CardHeader>
          ...
          <CardDescription>Inclua o nome e o logo da igreja para aparecerem na parte superior.</CardDescription>
        </CardHeader>
      ...
      <Card className="border-border/60 bg-card/80">
        ...
        <CardContent>
          <ApresentacaoMeninoCertificateBuilder igrejaNome={igrejaNome || "Igreja"} logoUrl={logoUrl || undefined} logoPath={logoPath} />
        </CardContent>
      </Card>
    </main>
  );
