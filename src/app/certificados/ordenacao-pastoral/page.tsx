...
import { OrdenacaoPastoralCertificateBuilder } from "../_components/ordenacao-pastoral-certificate-builder";

export default function CertificadoOrdenacaoPastoralPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl space-y-6 px-6 py-12 md:px-10 lg:px-16">
      <header className="space-y-4">
        ...
        <h1 className="text-2xl font-semibold text-foreground">Certificado de Ordenação Pastoral</h1>
        <p className="text-sm text-muted-foreground">
          Registre a ordenação pastoral com os dados do ordenando, igreja ordenadora e data da imposição de mãos.
        </p>
      ...
      <Card className="border-border/60 bg-card/80">
        ...
        <CardContent>
          <OrdenacaoPastoralCertificateBuilder igrejaNome={igrejaNome || "Igreja"} logoUrl={logoUrl || undefined} logoPath={logoPath} />
        </CardContent>
      </Card>
    </main>
  );
